    ...
    <div className='productdisplay'>
        ...
        <div className="productdisplay-right">
            ...
            <div className="productdisplay-right-discription">
                bfhjsddbgdfgkndksbgisdngdsngverjrgauosngngngdngjdgndjgbdsfbgzisgjgjfdsjgnregjngjn
                ddhgbhdngnkjdngdbishguaetjgakgeptoergrkmgrg
                rkgnerghisejgserngsjgihsbgsergi5
            </div>
